...
class Kernel extends HttpKernel
{
     ...
     *
     * @var array<int, class-string<\Illuminate\Contracts\Http\Middleware\Middleware>> 
     */
     ...
     *
     * @var array<string, class-string<\Illuminate\Contracts\Http\Middleware\Middleware>>
     */
    protected $routeMiddleware = [
        ...
        // Aquí agregamos nuestro middleware de roles
        'role' => \App\Http\Middleware\EnsureRole::class,  // Middleware para roles
    ];
